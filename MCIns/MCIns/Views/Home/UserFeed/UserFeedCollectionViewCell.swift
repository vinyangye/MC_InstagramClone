...
//  MCIns
//
//  Created by Charles Huang on 25/9/18.
...
//        self.postImage.addGestureRecognizer(swipeGesture_postImg)
    ...
    @IBAction func viewAllCommentsButton_TouchUpInside(_ sender: Any) {
...
//        }
    ...
    func likeNotification() {
        ...
        let newPostId = currentPost.postId
...
//        activityController.popoverPresentationController?.sourceView = view
    ...
    func setupBasic(){
        ...
        self.viewAllCommentButton.setTitle("View All Comments", for: .normal)
        self.viewAllCommentButton.setTitleColor(UIColor.lightGray, for: .normal)
    }
